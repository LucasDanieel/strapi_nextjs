import { GridContenteProps } from "../components/GridContente";
...
export const mapSectionTwoColumns = (section = {} as any): GridTwoColumnProps => {
  const {
...
export const mapSectionContent = (section = {} as any): GridContenteProps => {
  const {
    __component: component = "",
    title = "",
    content: html = "",
